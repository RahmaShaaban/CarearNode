...
// const FeedbackDashboard = ({ allResults, isArabic, handleStartNew ,interviewId}) => {
//     const [selectedView, setSelectedView] = useState('overall');
//     const [activeTab, setActiveTab] = useState('vision');
//     const [isDownloading, setIsDownloading] = useState(false);
//     const reportRef = useRef();
...
//                 <button onClick={handleExportPDF} disabled={isDownloading} style={{ backgroundColor: '#ffffff', color: darkGreen, border: 'none', padding: '12px 24px', borderRadius: '8px', fontWeight: 'bold', fontSize: '1rem', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', transition: 'all 0.2s ease', boxShadow: '0 2px 8px rgba(47, 93, 84, 0.1)' }}>
//                     <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
//                         <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
//                         <polyline points="7 10 12 15 17 10"></polyline>
//                         <line x1="12" y1="15" x2="12" y2="3"></line>
...
//             {selectedView === 'overall' ? (
//                 <OverallFeedback allResults={allResults} isArabic={isArabic} interviewId={interviewId}/>
//             ) : currentResult.error ? (
//                 <div style={{textAlign: 'center', padding: '50px', color: 'red', fontSize: '1.2rem'}}>
//                     {isArabic ? "حدث خطأ أثناء تحليل هذا السؤال." : "Error analyzing this specific question."}
//                 </div>
...
//                         <div style={{ background: '#f8fafc', padding: '20px', borderRadius: '12px', borderLeft: isArabic ? 'none' : `5px solid ${primaryColor}`, borderRight: isArabic ? `5px solid ${primaryColor}` : 'none', marginBottom: '30px', textAlign: isArabic ? 'right' : 'left' }}>
//                             <h3 style={{ margin: 0, color: darkGreen, fontSize: '1.4rem' }}>"{currentResult.questionText}"</h3>
//                         </div>

//                         {wordsCount < 3 && (
//                             <div style={{ backgroundColor: '#fff4f4', border: '1px solid #fca5a5', color: '#b91c1c', padding: '15px 20px', borderRadius: '8px', marginBottom: '25px', display: 'flex', alignItems: 'center', gap: '10px', flexDirection: isArabic ? 'row-reverse' : 'row', textAlign: isArabic ? 'right' : 'left' }}>
//                                 <span style={{ fontSize: '1.5rem' }}>⚠️</span>
//                                 <div>
//                                     <strong style={{ display: 'block', fontSize: '1.1rem', marginBottom: '5px' }}>{isArabic ? "تنبيه: محتوى غير كافٍ للتقييم" : "Warning: Insufficient Content"}</strong>
//                                     <span>{isArabic ? "لم يتمكن النظام من سماع إجابتك بوضوح أو أن الإجابة كانت قصيرة جداً." : "The system could not hear you clearly or the answer was too short."}</span>
//                                 </div>
//                             </div>
//                         )}
...
//                                         <DetailedAnalysisCard icon="⚡" title={isArabic ? 'إيماءات الشرح' : 'Explaining Gestures'} value={`${expScore}%`} score={expScore} colorHex={primaryColor} tip={expTip} isArabic={isArabic} />
//                                         <DetailedAnalysisCard icon="🪑" title={isArabic ? 'الجلوس باستقامة' : 'Sitting Straight'} value={`${strScore}%`} score={strScore} colorHex={primaryColor} tip={strTip} isArabic={isArabic} />
//                                         <DetailedAnalysisCard icon="👤" title={isArabic ? 'انفتاح الجسم' : 'Body Openness'} value={isArabic ? (opennessRaw === 'Open' ? 'منفتح' : (opennessRaw === 'Closed' ? 'منغلق' : 'عادي')) : opennessRaw} score={opennessScore} colorHex={opennessScore > 50 ? primaryColor : "#64748b"} tip={openTip} isArabic={isArabic} />
//                                     </div>
//                                     <div style={{ flex: '1', display: 'flex', flexDirection: 'column' }}>
//                                         <div style={{ display: 'flex', gap: '15px', marginBottom: '15px' }}>
//                                             <SquareCard icon='🖐️' label={isArabic ? 'يد مفتوحة' : 'Open Hands'} value={h.open_score || 0} subLabel={isArabic ? 'تبني الثقة' : 'Trust'} colorHex={primaryColor} isCircular={true} />
//                                             <SquareCard icon='✊' label={isArabic ? 'يد مغلقة' : 'Closed Hands'} value={h.clasped_score || 0} subLabel={isArabic ? 'توحي بالتوتر' : 'Nervous'} colorHex='#64748b' isCircular={true} />
//                                         </div>
//                                         <DetailedAnalysisCard icon="🙅" title={isArabic ? 'تكتيف الذراعين' : 'Crossed Arms'} value={`${crossedScore}%`} score={crossedScore} colorHex={crossedScore > 20 ? '#ef4444' : primaryColor} tip={crossTip} isArabic={isArabic} />
//                                         <DetailedAnalysisCard icon="😳" title={isArabic ? 'لمس الوجه' : 'Face Touches'} value={`${faceTouchScore}%`} score={faceTouchScore} colorHex={faceTouchScore > 20 ? '#ef4444' : primaryColor} tip={touchTip} isArabic={isArabic} />
//                                     </div>
//                                 </div>
//                                 <div style={{ marginTop: '20px', width: '50%' }}>
//                                     <DetailedAnalysisCard icon="👔" title={isArabic ? 'المظهر الرسمي' : 'Formal Attire'} value={isFormal ? (isArabic ? "رسمي" : "Formal") : (isArabic ? "كاجوال" : "Casual")} score={isFormal ? 100 : 35} colorHex={isFormal ? primaryColor : "#f97316"} tip={isFormal ? (isArabic ? "مظهر احترافي وممتاز." : "Excellent professional attire.") : (isArabic ? "يفضل ارتداء ملابس رسمية." : "Formal wear is preferred.")} isArabic={isArabic} />
//                                 </div>
//                                 <div style={{ marginTop: '20px', backgroundColor: '#f8fafc', borderRadius: '10px', borderLeft: isArabic ? 'none' : `6px solid ${primaryColor}`, borderRight: isArabic ? `6px solid ${primaryColor}` : 'none', padding: '20px', textAlign: isArabic ? 'right' : 'left' }}>
//                                     <strong style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px', color: primaryColor, flexDirection: isArabic ? 'row-reverse' : 'row' }}>
//                                         <span>💡</span> {isArabic ? "نصيحة الأداء الجسدي:" : "Body Language Advice:"}
//                                     </strong>
...
//                         {activeTab === 'eye' && (
//                             <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
//                                 <div style={{ borderBottom: '2px solid #e2e8f0', paddingBottom: '15px', textAlign: isArabic ? 'right' : 'left' }}>
//                                     <h2 style={{ color: darkGreen, margin: 0 }}>{isArabic ? "التواصل البصري والرأس" : "Eye & Head Tracking"}</h2>
//                                 </div>
//                                 <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', flexDirection: isArabic ? 'row-reverse' : 'row' }}>
//                                     <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '15px' }}>
//                                         <SquareCard icon='👁️' label={isArabic ? 'التواصل البصري' : 'Eye Contact'} value={eye.score} colorHex={primaryColor} isCircular={true} />
//                                         <div style={{ backgroundColor: '#f0f7f5', border: `1px solid ${primaryColor}`, borderRadius: '12px', padding: '20px', color: darkGreen, textAlign: isArabic ? 'right' : 'left' }}>
//                                             <strong>{isArabic ? "نصيحة:" : "Advice:"}</strong> <p>{eye.advice || "-"}</p>
//                                         </div>
//                                     </div>
//                                     <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '15px' }}>
//                                         <SquareCard icon='👤' label={isArabic ? 'توجيه الرأس' : 'Head Pose'} value={head.score} colorHex={primaryColor} isCircular={true} />
//                                         <div style={{ backgroundColor: '#f0f7f5', border: `1px solid ${primaryColor}`, borderRadius: '12px', padding: '20px', color: darkGreen, textAlign: isArabic ? 'right' : 'left' }}>
//                                             <strong>{isArabic ? "نصيحة:" : "Advice:"}</strong> <p>{head.advice || "-"}</p>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </div>
...
//                             <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
//                                 <div style={{ borderBottom: '2px solid #e2e8f0', paddingBottom: '15px', textAlign: isArabic ? 'right' : 'left' }}>
//                                     <h2 style={{ color: darkGreen, margin: 0 }}>{isArabic ? "التعابير العاطفية" : "Emotional Expression"}</h2>
//                                 </div>
//                                 <div style={{ display: 'flex', gap: '20px', flexDirection: isArabic ? 'row-reverse' : 'row', flexWrap: 'wrap' }}>
...
//                                         <div style={{ fontSize: '3rem', marginBottom: '15px' }}>😃</div>
//                                         <div style={{ fontWeight: '600' }}>{isArabic ? 'إيجابي' : 'Positive'}</div>
//                                         <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: primaryColor }}>{face.positive || 0}%</div>
//                                     </div>
//                                     <div style={{ flex: '1', backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #e2e8f0', padding: '25px 15px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
//                                         <div style={{ fontSize: '3rem', marginBottom: '15px' }}>😐</div>
//                                         <div style={{ fontWeight: '600' }}>{isArabic ? 'محايد' : 'Neutral'}</div>
//                                         <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#64748b' }}>{face.neutral || 0}%</div>
//                                     </div>
//                                     <div style={{ flex: '1', backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #e2e8f0', padding: '25px 15px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
//                                         <div style={{ fontSize: '3rem', marginBottom: '15px' }}>😥</div>
//                                         <div style={{ fontWeight: '600' }}>{isArabic ? 'سلبي' : 'Negative'}</div>
//                                         <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#ef4444' }}>{face.negative || 0}%</div>
//                                     </div>
//                                 </div>
//                                 <div style={{ backgroundColor: '#f8fafc', borderRadius: '10px', borderLeft: isArabic ? 'none' : `6px solid ${primaryColor}`, borderRight: isArabic ? `6px solid ${primaryColor}` : 'none', padding: '25px', textAlign: isArabic ? 'right' : 'left' }}>
//                                     <h4 style={{ margin: '0 0 10px 0', color: primaryColor }}>{isArabic ? "الخلاصة:" : "Conclusion:"}</h4>
//                                     <p style={{ margin: 0, color: darkGreen }}>
//                                         { (face.positive > 50) ? (isArabic ? "تعبيراتك تعكس حماساً وثقة." : "Your expressions reflect enthusiasm and confidence.") : (isArabic ? "تعبيراتك هادئة، حاول الابتسام أكثر." : "Your expressions are calm, try to smile more.") }
//                                     </p>
//                                 </div>
//                             </div>
//                         )}
...
//     <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
//         <div style={{ borderBottom: '2px solid #e2e8f0', paddingBottom: '15px', textAlign: isArabic ? 'right' : 'left' }}>
//             <h2 style={{ color: darkGreen, margin: 0 }}>{isArabic ? "تحليل النطق" : "Speech Analysis"}</h2>
//         </div>
//         <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', flexDirection: isArabic ? 'row-reverse' : 'row' }}>
...
// <SquareCard 
//     icon='🗣️' 
//     label={isArabic ? 'سرعة التحدث' : 'Speaking Pace'} 
//     value={`${s.wpm || 0} WPM`} // إضافة وحدة WPM جنب الرقم
//     subLabel={s.wpm_feedback || (isArabic ? 'كلمة/دقيقة' : 'Words per minute')} 
...
// <SquareCard 
//     icon='🎙️' 
//     label={isArabic ? 'نبرة الصوت' : 'Voice Tone'} 
//     value={s.tone || "N/A"} 
//     subLabel={isArabic ? 'تحليل النبرة' : 'Tone Analysis'} 
//     colorHex={primaryColor}
//     isTextValue={true} 
// />
...
// <SquareCard 
//     icon='⏸️' 
//     label={isArabic ? 'نسبة التوقفات' : 'Pauses Ratio'} 
//     value={`${s.pause_ratio || 0}%`} // إضافة علامة الـ % هنا
//     subLabel={s.speech_pattern || (isArabic ? 'نمط الكلام' : 'Speech Pattern')} 
//     colorHex={(s.pause_ratio || 0) > 40 ? '#f59e0b' : primaryColor} 
// />
//         </div>

//         {/* الـ Transcript اللي كان شغال هيفضل زي ما هو */}
//         <div style={{ backgroundColor: '#f8fafc', padding: '20px', borderRadius: '10px', borderRight: isArabic ? `6px solid ${primaryColor}` : 'none', borderLeft: isArabic ? 'none' : `6px solid ${primaryColor}`, textAlign: isArabic ? 'right' : 'left' }}>
//             <p style={{ margin: 0, color: darkGreen }}>
//                 {isArabic ? "النص المسجل: " : "Transcript: "} {s.transcript || "..."}
//             </p>
//         </div>
//     </div>
// )}
...
//         {/* 1. Score Badge - بيظهر فوق عاليمين أو الشمال حسب اللغة */}
//         <div style={{ 
//             display: 'flex', 
...
//                 {currentResult.content?.score || 0}/100
//             </div>
//         </div>

//         {/* 2. General Feedback Section - الكارت الكبير */}
//         <div style={{ 
...
//                 paddingBottom: '10px'
//             }}>
//                 📢 {isArabic ? "التقييم العام:" : "General Feedback:"}
//             </h4>
//             <p style={{ color: '#475569', lineHeight: '1.6', fontSize: '1.05rem', marginTop: '15px' }}>
//                 {currentResult.content?.feedback || (isArabic ? "لا يوجد تقييم متاح حالياً." : "No feedback available.")}
//             </p>
//         </div>
...
//             {/* 3. Tips to Improve - الكارت الأصفر */}
//             <div style={{ 
...
//                     💡 {isArabic ? "نصائح للتطوير:" : "Tips to Improve:"}
//                 </h4>
//                 <ul style={{ 
//                     listStyleType: 'none', 
//                     padding: 0, 
...
//                         <li>{isArabic ? "لا توجد نصائح حالياً." : "No tips available."}</li>
//                     )}
//                 </ul>
//             </div>

//             {/* 4. Ideal Answer - الكارت الأخضر */}
//             <div style={{ 
...
//                     ✅ {isArabic ? "الإجابة المثالية:" : "Ideal Answer:"}
//                 </h4>
//                 <div style={{ 
//                     color: '#166534', 
//                     lineHeight: '1.7', 
...
//                     border: '1px solid #dcfce7'
//                 }}>
//                     {currentResult.content?.ideal_answer || (isArabic ? "سيتم توفير الإجابة المثالية قريباً." : "Ideal answer will be provided soon.")}
//                 </div>
//             </div>
//         </div>
//     </div>
...
const FeedbackDashboard = ({ allResults, isArabic, handleStartNew ,interviewId}) => {
    // ==================== [الـ States القديمة والجديدة مع بعض] ====================
    const [selectedView, setSelectedView] = useState('overall');
    const [activeTab, setActiveTab] = useState('vision');
    const [isDownloading, setIsDownloading] = useState(false);
    const reportRef = useRef();
    
    // الـ States الجديدة الخاصة بالـ Modal
    ...
    // الفانكشن الخاصة بمعالجة إرسال الإيميل تفتح وتغلق الـ Loading بنجاح
                    ...
                    <div className="result-content" ref={reportRef} style={{ padding: '20px', backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #dbece8', boxShadow: '0 4px 15px rgba(47, 93, 84, 0.05)' }}>
                        ...
                        {activeTab === 'speech' && (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                ...
                                <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', flexDirection: isArabic ? 'row-reverse' : 'row' }}>
                                    <SquareCard icon='🗣️' label={isArabic ? 'سرعة التحدث' : 'Speaking Pace'} value={`${s.wpm || 0} WPM`} subLabel={s.wpm_feedback || (isArabic ? 'كلمة/دقيقة' : 'Words per minute')} colorHex={primaryColor} />
                                    <SquareCard icon='🎙️' label={isArabic ? 'نبرة الصوت' : 'Voice Tone'} value={s.tone || "N/A"} subLabel={isArabic ? 'تحليل النبرة' : 'Tone Analysis'} colorHex={primaryColor} isTextValue={true} />
                                    <SquareCard icon='⏸️' label={isArabic ? 'نسبة التوقفات' : 'Pauses Ratio'} value={`${s.pause_ratio || 0}%`} subLabel={s.speech_pattern || (isArabic ? 'نمط الكلام' : 'Speech Pattern')} colorHex={(s.pause_ratio || 0) > 40 ? '#f59e0b' : primaryColor} />
                                </div>
                                <div style={{ backgroundColor: '#f8fafc', padding: '20px', borderRadius: '10px', borderRight: isArabic ? `6px solid ${primaryColor}` : 'none', borderLeft: isArabic ? 'none' : `6px solid ${primaryColor}`, textAlign: isArabic ? 'right' : 'left' }}>
                                    <p style={{ margin: 0, color: darkGreen }}>
                                        {isArabic ? "النص المسجل: " : "Transcript: "} {s.transcript || "..."}
                        ...
                        {activeTab === 'content' && (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '25px', position: 'relative' }}>
                                <div style={{ display: 'flex', justifyContent: isArabic ? 'flex-start' : 'flex-end', marginBottom: '-10px' }}>
                                    <div style={{ backgroundColor: '#0f4c5c', color: 'white', padding: '10px 25px', borderRadius: '25px', fontWeight: 'bold', fontSize: '1.2rem', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
                                        {isArabic ? "الدرجة: " : "Score: "} {currentResult.content?.score || 0}/100
                                    </div>
                                </div>

                                <div style={{ backgroundColor: '#f8fafc', padding: '25px', borderRadius: '15px', border: '1px solid #e2e8f0', textAlign: isArabic ? 'right' : 'left', boxShadow: '0 2px 4px rgba(0,0,0,0.02)' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '20px' }}>
                                    <div style={{ backgroundColor: '#fffdf5', padding: '25px', borderRadius: '15px', border: '1px solid #fef3c7', textAlign: isArabic ? 'right' : 'left' }}>
                                        <h4 style={{ color: '#92400e', display: 'flex', alignItems: 'center', gap: '10px', marginTop: 0 }}>
                                            💡 {isArabic ? "نصائح للتطوير:" : "Tips to Improve:"}
                                        </h4>
                                        <ul style={{ listStyleType: 'none', padding: 0, color: '#92400e', marginTop: '15px' }}>
                                            {(currentResult.content?.tips || []).map((tip, i) => (
                                                <li key={i} style={{ marginBottom: '15px', display: 'flex', gap: '10px', alignItems: 'flex-start', lineHeight: '1.5' }}>
                                                    <span style={{ fontSize: '1.2rem' }}>•</span>
                                                    <span>{tip}</span>
                                                </li>
                                            ))}
                                    ...
                                    <div style={{ backgroundColor: '#f0fdf4', padding: '25px', borderRadius: '15px', border: '1px solid #dcfce7', textAlign: isArabic ? 'right' : 'left' }}>
                                        <h4 style={{ color: '#166534', display: 'flex', alignItems: 'center', gap: '10px', marginTop: 0 }}>
                                            ✅ {isArabic ? "الإجابة المثالية:" : "Ideal Answer:"}
                                        </h4>
                                        <div style={{ color: '#166534', lineHeight: '1.7', fontSize: '0.95rem', backgroundColor: 'rgba(255,255,255,0.6)', padding: '15px', borderRadius: '10px', marginTop: '15px', border: '1px solid #dcfce7' }}>
                                            {currentResult.content?.ideal_answer || (isArabic ? "سيتم توفير الإجابة المثالية قريباً." : "Ideal answer will be provided soon.")}
                                        </div>
                                    </div>
                                </div>
