...
const AnalyzingLoader = ({ onSendToEmail }) => {
    // 🎨 Color Palette
    ...
    const handleSubmitEmail = () => {
        ...
        // Sends the email to the Backend (function passed from parent)
        onSendToEmail(email);
        setIsSubmitted(true);
    };
    ...
    return (
        <div style={{
            ...
            <p style={{ color: '#64748b', fontSize: '1.1rem', marginBottom: '40px', textAlign: 'center' }}>
                This might take a few minutes. Please don't close the page.
            </p>
                ...
                {isSubmitted ? (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                        ...
                        <p style={{ color: '#475569', margin: 0, fontSize: '0.95rem' }}>
                            You can close this page. We'll email you the results once ready.
                        </p>
                    </div>
                ) : !showEmailInput ? (
                    // "Email me the results" Button
                    <div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                        <h4 style={{ color: darkGreen, margin: 0, textAlign: 'left' }}>
                            Enter your email:
                        </h4>
                        <input 
                            type="email" 
